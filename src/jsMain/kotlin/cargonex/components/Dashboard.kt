        ...
        div {
            ...
            div {
                ...
                p {
                    ...
                    +"Cargonex turns that instinct into a decision — automatically, the moment the data shifts."
                }
                a {
                    href = "#"
        ...
        div {
            ...
            div {
                ...
                p {
                    ...
                    +"Join SAIL's procurement team and get early access to Cargonex — built for the decisions that move the world."
                }
                div {
