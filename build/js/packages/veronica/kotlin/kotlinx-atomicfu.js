(function (factory) {
  ...
  protoOf(AtomicRef).nd = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).od = function () {
  ...
  protoOf(AtomicBoolean).pd = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).od = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).qd = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).od = function () {
    return this.kotlinx$atomicfu$value;
  };
